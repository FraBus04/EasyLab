...
public partial class PianifPlanning
{
    ...
    public DateOnly? DataCommFirst { get; set; }
    ...
    public DateOnly? DataPianifLancio { get; set; }
    ...
    public string? WkDataMin { get; set; }

    public string? WkDataMax { get; set; }

    public string? WkdataPianifLancio { get; set; }

    public string? WkdataPianifProd { get; set; }

    public string? WkdataPianifRientro { get; set; }

    public string? WkDataMaxRientro { get; set; }

    public string? WkcommDataConfRientro { get; set; }
    ...
    public DateOnly? CommDataConfRientro { get; set; }

    public int? CommckConf { get; set; }

    public DateOnly? CommData { get; set; }
}
