...
public partial class BarCode
{
    ...
    public string RetailPriceEuro { get; set; } = null!;

    public string RetailPriceChf { get; set; } = null!;

    public string RetailPriceUsd { get; set; } = null!;

    public string RetailPriceGbp { get; set; } = null!;
