...
public partial class VTabAnagCliFor1
{
    ...
    public string? TipoListinoCod { get; set; }

    public string? TipoListinoDescr { get; set; }
    ...
    public string? Ragg4Cod { get; set; }

    public string? Ragg4Desc { get; set; }

    public int? IdRagg5 { get; set; }

    public string? Ragg5Cod { get; set; }
    ...
    public string? ModoCorrisp { get; set; }
    ...
    public string? CodIvaCod { get; set; }
