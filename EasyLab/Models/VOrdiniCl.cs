...
public partial class VOrdiniCl
{
    ...
    public double? PzArtEur { get; set; }
    ...
    public string? CapCitta { get; set; }
    ...
    public string? CatMercMacroEng2 { get; set; }
    ...
    public string? CatMercEng2 { get; set; }
    ...
    public string? NrCommLab { get; set; }

    public DateOnly? NrDdtdata { get; set; }
    ...
    public string? BuonoPrelievo { get; set; }

    public string? BuonoPrelievoStato { get; set; }
    ...
    public string? DdtTraspCura { get; set; }

    public string? DdtResa { get; set; }

    public string? DdtResaCod { get; set; }

    public string? DdtVettore { get; set; }
    ...
    public string? PercIvadesc { get; set; }

    public string? CcliNota { get; set; }
    ...
    public string? RaggMod1Cod { get; set; }

    public string? RaggMod1Desc { get; set; }

    public int? IdImballo { get; set; }

    public string? Imballo { get; set; }

    public int? IdImballoMod { get; set; }

    public int? CcliImp1 { get; set; }

    public int? CcliImp1Dest { get; set; }
    ...
    public string? Ragg1Label { get; set; }
    ...
    public int? CatMercMacroOrdPm2 { get; set; }
