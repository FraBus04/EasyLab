...
public partial class PianificazioneStatoOrdiniCf
{
    ...
    public string? VistaTempo { get; set; }

    public string? VistaDett { get; set; }
    ...
    public int? TotNr1 { get; set; }

    public double? TotVal1 { get; set; }

    public int? TotNr5 { get; set; }

    public double? TotVal5 { get; set; }

    public int? TotNr6 { get; set; }

    public double? TotVal6 { get; set; }

    public double? TotVal11 { get; set; }

    public double? TotNr1Perc { get; set; }

    public double? TotVal1Perc { get; set; }

    public double? TotNr5Perc { get; set; }

    public double? TotVal5Perc { get; set; }

    public double? TotNr6Perc { get; set; }

    public double? TotVal6Perc { get; set; }

    public double? TotNr11Perc { get; set; }

    public double? TotVal11Perc { get; set; }

    public DateOnly? LastSped { get; set; }
}
