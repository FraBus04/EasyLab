...
public partial class VProduzGeneCommesseSaldi2
{
    ...
    public int TotNr { get; set; }

    public int Ri1 { get; set; }

    public int Ri2 { get; set; }

    public int Ri3 { get; set; }

    public int Ri4 { get; set; }

    public int Ri5 { get; set; }

    public int Ri6 { get; set; }

    public int Ri7 { get; set; }

    public int Ri8 { get; set; }

    public int Ri9 { get; set; }

    public int Ri10 { get; set; }

    public int? Ri11 { get; set; }

    public int? Ri12 { get; set; }

    public int? Ri13 { get; set; }

    public int? Ri14 { get; set; }

    public int? Ri15 { get; set; }

    public int? Ri16 { get; set; }

    public int? TotRi { get; set; }
    ...
    public int Dr5 { get; set; }

    public int Dr6 { get; set; }

    public int Dr7 { get; set; }

    public int Dr8 { get; set; }

    public int Dr9 { get; set; }

    public int Dr10 { get; set; }

    public int Dr11 { get; set; }

    public int? Dr12 { get; set; }

    public int? Dr13 { get; set; }

    public int? Dr14 { get; set; }

    public int? Dr15 { get; set; }

    public int? Dr16 { get; set; }

    public int TotDr { get; set; }

    public string? Saldo { get; set; }

    public string? SaldoDesc { get; set; }

    public string? NotaComm { get; set; }
    ...
    public double? QtaRi { get; set; }

    public double QtaDr { get; set; }
