...
public partial class ImpDibaMp001
{
    ...
    public int? CkEsisteAnagCf { get; set; }

    public int? IdFornitore { get; set; }

    public int? CkEsisteMat { get; set; }

    public int? CkEsisteMatCol { get; set; }

    public int? CkEsisteModCol { get; set; }
    ...
    public string? CodColProd { get; set; }
