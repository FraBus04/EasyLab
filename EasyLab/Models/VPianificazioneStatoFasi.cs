...
public partial class VPianificazioneStatoFasi
{
    ...
    public int? Car16 { get; set; }

    public int? Car17 { get; set; }

    public int? Car18 { get; set; }

    public int? Car19 { get; set; }

    public int? Car20 { get; set; }

    public int? Ric1 { get; set; }

    public int? Ric2 { get; set; }

    public int? Ric3 { get; set; }

    public int? Ric4 { get; set; }

    public int? Ric5 { get; set; }

    public int? Ric6 { get; set; }

    public int? Ric7 { get; set; }

    public int? Ric8 { get; set; }

    public int? Ric9 { get; set; }

    public int? Ric10 { get; set; }

    public int? Ric11 { get; set; }

    public int? Ric12 { get; set; }

    public int? Ric13 { get; set; }

    public int? Ric14 { get; set; }

    public int? Ric15 { get; set; }

    public int? Ric16 { get; set; }

    public int? Ric17 { get; set; }

    public int? Ric18 { get; set; }

    public int? Ric19 { get; set; }

    public int? Ric20 { get; set; }
    ...
    public int? Diff16 { get; set; }

    public int? Diff17 { get; set; }

    public int? Diff18 { get; set; }

    public int? Diff19 { get; set; }

    public int? Diff20 { get; set; }

    public string? PathImgCol { get; set; }

    public string? PathImgMod { get; set; }

    public int? UteIns { get; set; }
    ...
    public DateOnly? DataCarFirst { get; set; }
    ...
    public int? TotCapiFase1 { get; set; }

    public int? TotCapiFase2 { get; set; }

    public int? TotCapiFase3 { get; set; }

    public int? TotCapiFase4 { get; set; }

    public int? TotCapiFase5 { get; set; }

    public int? TotCapiFase6 { get; set; }

    public int? TotCapiFase7 { get; set; }

    public int? TotCapiFase8 { get; set; }

    public int? TotCapiFase9 { get; set; }

    public int? TotCapiFase10 { get; set; }
