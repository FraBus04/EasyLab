...
public partial class WBasiAll
{
    ...
    public string ParteDesc { get; set; } = null!;
    ...
    public int? IdTgDa { get; set; }

    public int? IdTgA { get; set; }
    ...
    public int? CkMrp { get; set; }

    public int? CkFabb { get; set; }
}
