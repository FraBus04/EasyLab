...
public partial class ExportModelli2
{
    ...
    public string? RetailPriceEuro { get; set; }

    public string? RetailPriceChf { get; set; }

    public string? RetailPriceUsd { get; set; }

    public string? RetailPriceGbp { get; set; }
