...
public partial class VBiAnalisiProdottiStato
{
    ...
    public int? TotMagDispDaAss { get; set; }

    public string? SelTipoOrdineCl { get; set; }

    public string? SelTipoModello { get; set; }

    public string? SelMagazzini { get; set; }

    public string? SelCanaleVendita { get; set; }
}
